...
Инструкции записываются в little endian - наименьший разряд (little end) находится по наименьшему адресу. Когда мы записываем это как число `0x00fc45c7`, мы читаем байты в обратном порядке: `00 FC 45 C7`.
# Архитектуры
