...
В безопасную работу в облаке вносят вклад и облачный провайдер, и пользователь. Это называется разделяемой ответственностью (shared responsibility). На российском рынке не дают возместить сумму ущерба большую, чем стоимость за услуги.
